...
async function testBackpackFundingRateParsing() {
    ...
    const parsedFundingRate = exchange.parseFundingRate(fundingRateData, exchange.markets['SOL_USDC_PERP']);
...
async function testBackpackBorrowRateParsing() {
    ...
    const parsedBorrowRate = exchange.parseBorrowRate(borrowRate, { 'code': 'USDC', 'id': 'USDC' });
